    ...
    <div class="row">
        ...
        <div class="col-md-4 text-center">
            <div class="dropdown show">
                    <a class="btn btn-secondary text-light dropdown-toggle" href="?sort=default" id="sort-menu" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sort: Date (Newest)</a>  
                <div class="dropdown-menu" id="sort-dropdown" aria-labelledby="sort-menu">
                    <a class="dropdown-item sort d-none" href="?sort=date&order=new" sorttype="date" sortorder="new" id="sort-date-new">Sort: Date (Newest)</a>
